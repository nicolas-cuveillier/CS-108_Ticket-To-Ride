...
public class RouteTest {
    ...
    void checkIllegalArgumentExceptionWhenSameStation() {
        ...
        Assertions.assertThrows(IllegalArgumentException.class, () -> {
            new Route("test", s, s, 2, Route.Level.OVERGROUND, Color.BLACK);
        });
        Assertions.assertThrows(IllegalArgumentException.class, () -> {
            new Route("test", s, s, 7, Route.Level.OVERGROUND, Color.BLACK);
        });
    }
    ...
    void checkNulPointerExceptionWhenNullStation() {
        ...
        Assertions.assertThrows(NullPointerException.class, () -> {
            new Route("test", s1, s2, 2, null, Color.BLACK);
        });
    ...
    void checkOppositeStations() {
        ...
        Assertions.assertThrows(IllegalArgumentException.class, () -> {
            r.stationOpposite(new Station(3, "other"));
        });
    }
